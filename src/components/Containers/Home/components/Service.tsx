            ...
            <div className="w-full px-4">
              <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-8 md:gap-12 xl:gap-16">
                ...
                <div className="flex gap-4 md:gap-6">
                  <div className="w-12 md:w-14 h-12 md:h-14 flex justify-center items-center shrink-0 bg-primary text-white rounded-lg md:rounded-xl shadow-lg">
                    <svg
                  ...
                  <div>
                    ...
                    <a
                      href="#"
                      className="text-primary hover:text-primary active:text-primary font-bold transition duration-100"
                    >
                      More
                    </a>
                  </div>
